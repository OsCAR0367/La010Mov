...
@Composable
fun SeriesApp() {
    val urlBase = "http://192.168.0.106:8000/" // o tu IP si usarás un dispositivo externo
...
fun ScreenInicio() {
    Box(
        ...
        Text(text = "Bienvenido a la Series App", fontSize = 24.sp, fontWeight = FontWeight.Bold)
    }
}
